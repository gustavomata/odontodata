...
export const serieHistorica = [
  ...
  { ano: 2025, total: 440200, novosRegistros: 21400, cancelamentos: 2700 },
  { ano: 2026, total: 459800, novosRegistros: 22300, cancelamentos: 2700 },
];
...
export const fontesDados = [
  {
    ...
    dados: ["Registro de cirurgiões-dentistas", "Especialidades reconhecidas", "CROs estaduais", "TPDs registrados"],
  ...
  },
  {
    ...
    tipo: "Saúde Pública",
    dados: ["Estabelecimentos de saúde", "Profissionais vinculados", "LRPDs cadastrados", "CEOs e UBS"],
    atualizacao: "Mensal",
    abertoAcesso: true,
    api: true,
  },
  {
    ...
    dados: ["População por estado/município", "IDH regional", "Projeções demográficas", "PNS - acesso a dentista"],
    atualizacao: "Anual/Censo",
    abertoAcesso: true,
    api: true,
  },
  {
    nome: "DataSUS - SIA/SUS",
    url: "https://datasus.saude.gov.br/",
    tipo: "Produção Ambulatorial",
    dados: ["Procedimentos odontológicos", "Produção por tipo e município", "Cobertura SUS", "Próteses entregues"],
    atualizacao: "Mensal",
    abertoAcesso: true,
    api: false,
  },
  ...
  {
    nome: "MEC/INEP - Censo da Educação Superior",
    url: "https://www.gov.br/inep/",
    tipo: "Educação",
    dados: ["Faculdades de Odontologia", "Vagas, ingressantes, concluintes", "ENADE e CPC", "Taxa de evasão"],
    atualizacao: "Anual",
    abertoAcesso: true,
    api: true,
  },
  {
    nome: "SB Brasil - Pesquisa Nacional de Saúde Bucal",
    url: "https://bvsms.saude.gov.br/",
    tipo: "Epidemiologia",
    dados: ["CPO-D por faixa etária e região", "Prevalência de cárie", "Edentulismo", "Necessidade de prótese"],
    atualizacao: "Decenal",
    abertoAcesso: true,
    api: false,
  },
  {
    nome: "SIM/SINAN - Mortalidade e Agravos",
    url: "https://datasus.saude.gov.br/",
    tipo: "Vigilância Epidemiológica",
    dados: ["Óbitos por câncer bucal", "Incidência câncer de boca", "Notificações de agravos"],
    atualizacao: "Anual",
    abertoAcesso: true,
    api: false,
  },
  {
    ...
    tipo: "Oncologia",
    dados: ["Estimativas de câncer bucal", "Mortalidade por neoplasias", "Registros de base populacional"],
    atualizacao: "Anual",
    abertoAcesso: true,
    api: false,
  },
  {
    nome: "DAB/MS - Brasil Sorridente",
    url: "https://aps.saude.gov.br/",
    tipo: "Atenção Básica",
    dados: ["Equipes de Saúde Bucal", "CEOs implantados", "LRPDs credenciados", "Metas e indicadores"],
    atualizacao: "Mensal",
    abertoAcesso: true,
    api: true,
  },
  {
    nome: "VIGITEL - Vigilância de Fatores de Risco",
    url: "https://svs.aids.gov.br/",
    tipo: "Fatores de Risco",
    dados: ["Prevalência tabagismo", "Consumo de açúcar", "Diabetes/obesidade", "Impacto na saúde bucal"],
    atualizacao: "Anual",
    abertoAcesso: true,
    api: false,
  },
  {
    nome: "CAPES/Sucupira - Pós-Graduação",
    url: "https://sucupira.capes.gov.br/",
    tipo: "Pesquisa & Pós-Graduação",
    dados: ["Programas de mestrado/doutorado", "Notas dos programas", "Dissertações e teses", "Produção científica"],
    atualizacao: "Anual",
    abertoAcesso: true,
    api: true,
  },
  {
    nome: "e-MEC - Cadastro de IES",
    url: "https://emec.mec.gov.br/",
    tipo: "Regulação Educacional",
    dados: ["Conceito de curso (CPC)", "Situação do curso", "Dados da instituição"],
    atualizacao: "Contínua",
    abertoAcesso: true,
    api: true,
  },
  {
    nome: "CNPq/Lattes - Plataforma de Pesquisa",
    url: "https://lattes.cnpq.br/",
    tipo: "Pesquisa Científica",
    dados: ["Pesquisadores em Odontologia", "Grupos de pesquisa", "Bolsas e fomentos", "Patentes"],
    atualizacao: "Contínua",
    abertoAcesso: true,
    api: false,
  },
  {
    nome: "ANVISA - Agência de Vigilância Sanitária",
    url: "https://www.gov.br/anvisa/",
    tipo: "Regulação Sanitária",
    dados: ["Materiais odontológicos registrados", "Laboratórios certificados", "Regulamentação de insumos"],
    atualizacao: "Contínua",
    abertoAcesso: true,
    api: true,
  },
  {
    nome: "VIGIAGUA/SISAGUA - Qualidade da Água",
    url: "https://sisagua.saude.gov.br/",
    tipo: "Vigilância Ambiental",
    dados: ["Fluoretação da água", "Concentração de flúor por município", "Cobertura do sistema"],
    atualizacao: "Mensal",
    abertoAcesso: true,
    api: false,
  },
  {
    nome: "OMS/FDI - Dados Internacionais",
    url: "https://www.who.int/",
    tipo: "Comparação Internacional",
    dados: ["CPO-D por país", "Dentistas per capita global", "Gastos em saúde bucal", "Políticas de saúde oral"],
    atualizacao: "Anual",
    abertoAcesso: true,
    api: true,
  },
  {
    ...
    tipo: "Inovação & Patentes",
    dados: ["Patentes odontológicas", "Marcas de materiais", "Transferência de tecnologia"],
    atualizacao: "Contínua",
    abertoAcesso: true,
    api: true,
  },
